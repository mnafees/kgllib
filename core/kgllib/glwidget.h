...
#ifndef KGLLIB_GLWIDGET_H
#define KGLLIB_GLWIDGET_H
...
public:
     ...
     **/
    KGLLib::Camera* camera() const  { return mCamera; }
    /**
     * @return pointer to the @ref FPSCounter object. This is available after
     *  @ref initializeGL() has been called.
     **/
    KGLLib::FPSCounter* fpsCounter() const  { return mFpsCounter; }
...
protected:
     ...
     **/
    virtual void initializeGLWithRenderer(Renderer* r);
    /**
...
private:
    ...
    KGLLib::FPSCounter* mFpsCounter;
    mutable KGLLib::TextRenderer* mTextRenderer;
